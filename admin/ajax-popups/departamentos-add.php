...
<div class="popup-body left full">
    <form name="frmPopup" id="frmPopup">
        <div class="left col12 small12 padding5">
            <label class="left full mtop">Nombre del Aula/Departamento</label>
            <input type="text" id="nombre" name="nombre" value="" class="form-control left full validar">
        </div>
        <div class="left col12 small12 padding5">
            <label class="left full mtop">Descripcion del Aula/Departamento</label>
            <input type="textarea" id="descripcion" name="descripcion" value="" class="form-control left full">
        </div>
    </form>
...
<div class="popup-footer">
    <button type="button" class="btngral btnRegresar right mright" onclick="savePopup(this)" data-page="departamentos-add" data-load="<?php echo $postload; ?>" data-div="<?php echo $div; ?>">Guardar</button>
